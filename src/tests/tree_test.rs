...
#[test]
fn process_tree() {
    let tree_buf : PathBuf = ["c:\\", "Users", "ErwanMahe", "IdeaProjects", "graph_process_manager_loggers", "tree"].iter().collect();
    let temp_buf : PathBuf = ["c:\\", "Users", "ErwanMahe", "IdeaProjects", "graph_process_manager_loggers", "tree_temp"].iter().collect();
